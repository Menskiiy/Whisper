...
<head>
    ...
    <title>Новости - Друзья</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <div class="container">
        <h1>Новости <div class="text"> (Моих друзей) </div></h1>
                    ...
                    <div class="news-item">
						<div class="post-item">
							<div class="profile-avatar">
								<img src="uploads/<?php echo htmlspecialchars($post["avatar"]); ?>" alt="Аватар автора" class="avatar-image">
							</div>
							
								<div class="post-header">
									<span class="author-name"><?php echo htmlspecialchars($post["author"]); ?></span>
									<span class="post-date"><?php echo date("d.m.Y H:i", strtotime($post["timestamp"])); ?> (UTC)</span>
								</div>
								<p><?php echo htmlspecialchars($post["content"]); ?></p>
								<?php if (!empty($post["image"])): ?>
									<img src="uploads/<?php echo htmlspecialchars($post["image"]); ?>" alt="Изображение в посте" class="post-image" style="width: 50%; height: auto;">
								<?php endif; ?>
							</div>
                    </div>
                <?php endforeach; ?>
