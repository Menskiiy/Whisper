...
<body>
    ...
    <main>
        ...
        <div class="floating-element">
            ...
            <div class="container">
                <h1 class="toggle-link" data-form="login-form">Авторизация</h1>
                <?php
                    if (isset($_SESSION["error_message_login"])) {
                        echo "<p class='error-message'>{$_SESSION["error_message_login"]}</p>";
                ...
                <div class="form-container" id="login-form">
                    <form action="index.php" method="POST">
                        <label for="login_existing">Логин:</label><br>
                        <input type="text" id="login_existing" name="login_existing" required><br>

                        <label for="password_existing">Пароль:</label><br>
                        <input type="password" id="password_existing" name="password_existing" required><br>
